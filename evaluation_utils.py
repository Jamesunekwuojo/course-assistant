...
def llm_structured(client, instructions, user_prompt, output_type, model="llama-3.1-8b-instant"):
    import json
    schema_str = json.dumps(output_type.model_json_schema())
    instructions += f"\nOutput your response in JSON format exactly matching this schema:\n{schema_str}"
    messages = [
